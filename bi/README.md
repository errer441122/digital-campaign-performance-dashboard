...
These are text BI design artifacts and a dashboard screenshot route, not a published Power BI Service workspace, Tableau Public workbook or Looker Studio report. They use no production, client, advertising-platform, CRM or GA4 account data.
