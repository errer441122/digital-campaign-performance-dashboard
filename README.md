...
2. Review `reports/ab_test_marketing_uplift.md`, then `analysis/attribution.md`, `analysis/budget_reallocation.md` and `analysis/crm_retention.md`
...
| `src/generate_crm_data.py` | Seeded generator for the customer-level CRM order sample. |
...
| `src/validate_data.py` | Validates schema, required values and KPI calculations across all four CSVs. |
