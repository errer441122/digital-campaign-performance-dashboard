...
> **In 30 seconds**
> - **Finding:** Champions are 26% of 5,878 real customers but 71% of revenue, and a customer in Germany is worth 47% more over their lifetime than one in the UK. On simulated journeys, last-click over-credits Paid Search by 363 conversions versus a Markov model.
> - **Method:** RFM, cohort retention and CLV on the real UCI *Online Retail II* data (GBP); attribution, A/B test and budget model on disclosed simulated data. CI re-checks every headline number with pandas, DuckDB SQL and statsmodels.
> - **Open:** [**live dashboard**](https://errer441122.github.io/digital-campaign-performance-dashboard/) · [cross-check notebook](notebooks/cross_check.ipynb) · [executive summary](reports/executive_summary.md)
...
**[Open the live dashboard](https://errer441122.github.io/digital-campaign-performance-dashboard/)** — generated by `src/build_web_dashboard.py` from the committed analysis outputs.

The static preview below is built from the **real** UCI Online Retail II data (CC BY 4.0) — RFM
...
<details><summary>Full list of skills demonstrated</summary>
