...
2. Review `dashboard/campaign_dashboard.xlsx`
3. Check `docs/kpi_dictionary.md`
4. Read `docs/assumptions_and_limits.md`

## Boundaries

This is a portfolio case study using simulated data only. It does not claim access to real company, client, user, advertising or analytics data.
